/*
 ...
 International cities are listed after the US cities.
...
// UK
    ...
    var uk_london_r = JSON.parse(uk_london_weather.response);
    <!-- this is what prints to the screen/page/div -->
    var uk_london_info = uk_london_r.current_observation.display_location.city + "<br>" + uk_london_r.current_observation.temp_f + "&#8457  <br>" + "Wind: " + uk_london_r.current_observation.wind_dir + ", " + uk_london_r.current_observation.wind_mph + " mph" + "  <br>" + uk_london_r.current_observation.weather + "  <p>";
